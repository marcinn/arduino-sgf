...
RectFlashAnim::RectFlashAnim(RectFlashAnimSlot* slots, int slotCount, uint16_t whiteColor,
                             uint16_t warmWhiteColor)
    : slots_(slots),
...
void RectFlashAnim::spawn(int x0, int y0, int x1, int y1, uint32_t durationUs, uint16_t baseColor,
                          uint16_t lightColor) {
    int slot = -1;
