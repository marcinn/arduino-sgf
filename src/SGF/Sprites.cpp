...
int scaledWidth(const SpriteLayer::Sprite& s) { return s.w * scaleFactorX(s.scale); }

int scaledHeight(const SpriteLayer::Sprite& s) { return s.h * scaleFactorY(s.scale); }
...
void SpriteLayer::spriteBounds(const Sprite& s, int16_t* x0, int16_t* y0, int16_t* x1,
                               int16_t* y1) {
