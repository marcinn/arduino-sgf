...
static void blitStripSubRectRows(IRenderTarget& target, int dstX, int dstY, int w, int h,
...
void HardwareScroller::configureFullScreen() { configure(0, axisLength(), 0); }
...
void HardwareScroller::scroll(int delta, uint16_t* buf, int maxStripLines,
                              const RenderStripFn& renderStrip, const BlitStripFn& blitStrip) {
