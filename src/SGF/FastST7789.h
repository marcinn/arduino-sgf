...
class FastST7789 : public IRenderTarget, public IScreen {
   public:
    ...
    static constexpr Offset offset(uint16_t x, uint16_t y) { return Offset{x, y}; }

    static constexpr PanelConfig makePanelConfig(uint16_t width, uint16_t height,
        ...
        return PanelConfig{width,        height,        portrait,   landscape,
                           portraitFlip, landscapeFlip, colorOrder, invertColors};
    }
